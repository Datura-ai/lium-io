...
`tests-ok` reports green either way. A platform-side change (not merged) adds the same gate there (its
...
The same shape as the gate the platform side adds (not merged; that version also caps the whole
