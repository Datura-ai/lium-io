...
- `1.4.0` — `RentedExecutorsResponse.provider_email_held_executor_ids` (optional; the nodes the backend keeps unlisted until the provider confirms an e-mail address).
- `1.0.0` — first release.
