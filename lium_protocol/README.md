...
- `1.4.0` — `ContainerCreateRequest.secrets` (optional; renter secrets the validator writes as files on a tmpfs at `/run/lium/secrets`, behind its `POD_SECRETS_TMPFS_ENABLED` flag).
- `1.0.0` — first release.
