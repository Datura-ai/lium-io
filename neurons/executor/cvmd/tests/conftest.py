...
from cvmd.cvm.manager import CvmManager, Triple
...
# The launch fixtures live here rather than in test_launch.py because DAH-2580 added a
# second launch path with its own test module, and both need the same host: one signed
# catalog, one set of forwarded ports, one manager wired to a real dstack.py.
