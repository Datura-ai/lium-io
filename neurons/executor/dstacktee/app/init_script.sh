...
ENABLE_GPU_ATTESTATION \
GPU_ATTESTATION_ARCH \
EXECUTOR_LOCAL_VERIFY_ENABLED \
LOCAL_VERIFY_MAX_DEADLINE_SECONDS \
LOCAL_VERIFY_INTENT_WINDOW_SECONDS \
EXECUTOR_LOCAL_RENT_ENABLED \
LOCAL_RENT_MAX_DEADLINE_SECONDS \
"
