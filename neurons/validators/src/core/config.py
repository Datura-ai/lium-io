...
class Settings(BaseSettings):
    ...
    RENTED_GPU_FAULT_ENABLED: bool = Field(env="RENTED_GPU_FAULT_ENABLED", default=True)
    RENTED_GPU_FAULT_CYCLES: int = Field(env="RENTED_GPU_FAULT_CYCLES", default=2, ge=1)
