from datura.requests.validator_requests import LOCAL_VERIFY_DIND_IMAGE
...
DOCKER_DIND_IMAGE = LOCAL_VERIFY_DIND_IMAGE  # datura: the executor starts the same image (liumd 2c)
