...
class TenantEnforcementMessages:
    ...
    # DAH-2255: the same event when RENTED_POD_SSH_ENFORCEMENT_ENABLED is on and the streak has
    # reached the enforce threshold — the check fails the cycle instead of halting on it.
