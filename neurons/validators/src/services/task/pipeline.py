...
class ContextConfig:
    ...
    # Own-supply fast validation: True only for the FIRST, unscored verification of a node
    # registered under a dedicated own-supply miner hotkey (settings.OWN_SUPPLY_MINER_HOTKEYS —
